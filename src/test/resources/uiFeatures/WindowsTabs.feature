@regression @windowsTabs
Feature: This feature file validates Windows and Tabs Page Functionality

  Scenario: User should be able to handle new window on Windows and Tabs Page
